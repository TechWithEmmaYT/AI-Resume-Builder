                ...
                >
                  ...
                  <div className="flex items-center">
                    <div
                      ...
                      className="rounded-sm hover:bg-neutral-200 w-6 h-6 flex 
                      items-center justify-center  dark:hover:bg-gray-700"
                    >
                      {isPending ? (
                    ...
                    {/* <div
                      role="button"
                      onClick={(e) => onRestore(e, doc.documentId, doc.status)}
                      className="rounded-sm hover:bg-neutral-200 dark:hover:bg-gray-700"
                    >
